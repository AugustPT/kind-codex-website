...
const BREADTH = `BREADTH — KindCodex is NOT just a lead-response tool; missed calls/slow replies is ONE lane of many. Across the batch, ROTATE through DIFFERENT pain points AND DIFFERENT business types — at most ONE response-speed post per batch.
