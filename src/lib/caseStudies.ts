...
const associatedHawaii: CaseStudy = {
  ...
  painNav: "They don't trust you yet",
  headline: "When customers judge you before they ever call",
  summary:
    "Buyers were sizing up the team online long before they picked up the phone. We rebuilt the site so it earned that trust first — people arrived ready to talk instead of skeptical. Even if you've never sold a house, the same silent doubt is costing you calls.",
  ...
  detail: {
    title: "How a real estate team earned trust before the first phone call",
...
const eatonSquare: CaseStudy = {
  ...
  painNav: "Nobody can find you",
  headline: "When customers can't find you, they can't choose you",
  summary:
    "People couldn't tell what was even there, so they walked and scrolled right past. We turned a hidden spot into one customers actually find and choose. Whether you're tucked inside a plaza or buried below the fold on Google, being invisible costs you the same.",
  ...
  detail: {
    title: "How a hidden shopping center became easy to find and choose",
    client: "Eaton Square",
...
const iremHawaii: CaseStudy = {
  ...
  order: 3,
  industry: "Events",
  painNav: "You blend in",
  headline: "When your business blends in with everyone else",
  summary:
    "A milestone that should have felt unmissable was sliding toward 'just another invite.' We made it stand out and feel worth showing up for — before anyone arrived. If your business looks like every competitor in town, this is how you change that.",
  ...
  detail: {
    title: "How a 70-year milestone was made to stand out and feel premium",
    client: "IREM Hawaii",
...
const tlacuaches808: CaseStudy = {
  ...
  order: 4,
  industry: "Restaurant",
  painNav: "Clicks but no customers",
  headline: "When you get clicks but no customers",
  summary:
    "Visitors were interested but never finished — every extra tap quietly lost the order. We built a one-page path from 'I want it' to 'paid,' with nothing in the way. Getting traffic but no calls or orders? It's the same problem, whether you sell tacos or appointments.",
  ...
  detail: {
    title: "How a tucked-away restaurant turned visitors into orders",
...
const alohaPropertyManagers: CaseStudy = {
  ...
  painNav: "Leads that go cold",
  headline: "When good leads stall and go cold",
  summary:
    "Skeptical, faraway owners weren't about to hand over their property on a promise. We built a site that showed the operation actually working, so trust was earned before the first call. If your leads stall or go quiet, this is usually why — and the fix.",
  ...
  detail: {
    title: "How a property manager earned skeptical owners' trust before the call",
